...
export interface Database {
  public: {
    Tables: {
      ...
      monthly_settlements: {
        Row: { id: string; year: number; month: number; total_revenue: number; supply_value: number; total_incentive: number; total_product_cost: number; gross_profit: number; total_fixed_cost: number; total_variable_cost: number; total_special_cost: number; total_payroll: number; gonggu_gross_sales: number; gonggu_margin: number; gonggu_margin_supply: number; operating_profit: number; corporate_tax_reserve: number; retained_earnings: number; distributable_profit: number; representative_share: number; calculated_at: string }
        Insert: { id?: string; year: number; month: number; total_revenue: number; supply_value: number; total_incentive?: number; total_product_cost?: number; gross_profit: number; total_fixed_cost?: number; total_variable_cost?: number; total_special_cost?: number; total_payroll?: number; gonggu_gross_sales?: number; gonggu_margin?: number; gonggu_margin_supply?: number; operating_profit: number; corporate_tax_reserve?: number; retained_earnings?: number; distributable_profit: number; representative_share: number; calculated_at?: string }
        Update: { id?: string; year?: number; month?: number; total_revenue?: number; supply_value?: number; total_incentive?: number; total_product_cost?: number; gross_profit?: number; total_fixed_cost?: number; total_variable_cost?: number; total_special_cost?: number; total_payroll?: number; gonggu_gross_sales?: number; gonggu_margin?: number; gonggu_margin_supply?: number; operating_profit?: number; corporate_tax_reserve?: number; retained_earnings?: number; distributable_profit?: number; representative_share?: number; calculated_at?: string }
        Relationships: []
      }
      gonggu_sales: {
